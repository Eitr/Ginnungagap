...
public class GameScreen implements Screen {
    ...
    public GameScreen(final Drop g) {
        this.game = g;
        ...
        test = new Texture(100,100,Format.Alpha);
    }
    ...
    public void render(float delta) {
        ...
        // all drops
        game.batch.begin();
        game.font.draw(game.batch, "Drops Collected: " + dropsGathered, 10, screenHeight);
        ...
        if (TimeUtils.nanoTime() - lastDropTime > 1000)
            spawnRaindrop();
